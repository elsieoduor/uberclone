...
const RideCard = ({
  ...
  return (
    <View className="flex flwx-row items-center justify-center bg-white rounded-lg shadow-md shadow-neutral-300 mb-3">
      <View className="flex flex-col items-center justify-between p-3">
        ...
        <View className="flex flex-col w0full mt-5 bg-general-500 rounded-l p-3 items-start justify-center">
